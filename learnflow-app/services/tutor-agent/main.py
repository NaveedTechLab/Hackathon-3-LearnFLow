...
app = FastAPI(title="tutor-agent", description="Specialized agent for providing detailed coding explanations")
...
async def startup_event():
    logger.info("Tutor Agent started with Dapr integration")

@app.get("/")
async def root():
    return {"message": "Hello from Tutor Agent with Dapr!"}

@app.post("/process-coding-task")

...
Frontend -> Dapr -> Kafka -> PostgreSQL
"""
...
def check_cluster_status():
    """Check cluster status using kubectl and dapr commands."""
...
def main():
    ...
    parser.add_argument('--check-cluster', action='store_true', help='Also check cluster status with kubectl and dapr commands')
